...
public class VSSettingItem {
    ...
    private static final ItemStack enabled = ItemCreator.itemCreate(Material.STAINED_GLASS, "00A7aAktiviert", (short) 5);
    private static final ItemStack disabled = ItemCreator.itemCreate(Material.STAINED_GLASS, "00A7cDeaktiviert", (short) 14);
