...
public class Wasserholen implements Listener {
    ...
    public Wasserholen() {
        q.setInfoText(
                "Elsa bittet dich nicht darum, im n00e4chsten Schneek00f6niginnenwettbewerb f00fcr sie abzustimmen, sondern m00f6chte lediglich, dass du ihr drei volle Eimer Wasser bringst.");
    ...
    private void initDialog() {
        ...
        dialog_Start = new DialogMessage(q, elsa).setInhalt("Brian und Falto sind schon wieder verschwunden."
                ...
                + " Du wirst das f00fcr mich erledigen."
                + " Hier hast du ein paar Eimer. Die m00fcssen alle bis zum Rand voll werden!");
        ...
        withWater = new DialogMessage(q, elsa).setInhalt(
                "Die beiden Jungs sind noch immer verschwunden. Na warte, wenn sie nach Hause kommen, werde ich ihnen dieses Wasser 00fcber den Kopf sch00fctten! Danke f00fcr deine M00fche, als Belohnung darfst du einen der Eimer behalten.");
