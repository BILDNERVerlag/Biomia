        ...
        switch (getName().toLowerCase()) {
            case "setwarp":
                ...
                if (verbleibendeWarps <= 0) {
                    ...
                    p.sendMessage("\u00A7cBenutze \u00A77/\u00A7cdelwarp \u00A77<\u00A7cName\u00A77> \u00A7bum Warps zu l�schen \u00A7coder hol dir einen unserer Premiumr00e4nge und unterst\u00dctze damit den Server.");
                    return;
                }
                ...
                if (verbleibendeWarps <= 0)
                    ...
                    p.sendMessage("\u00A77Verbleibende Warppunkte: " + verbleibendeWarps + " \u00A77(vom Rang abh�ngig)");
                break;
            case "warp":
                if (!allowedGroups.contains(Biomia.getServerInstance().getServerType())) {
            ...
            case "delwarp":
                if (args.length < 1) {
                    p.sendMessage("\u00A77/\u00A7cdelwarp \u00A77<\u00A7cName\u00A77> \u00A7bum Warps zu l�schen");
                    return;
                }
                if (playerWarpLocations.containsKey(args[0])) {
                    ...
                    p.sendMessage("\u00A7cWarp \u00A7b" + args[0] + " \u00A7cwurde gel�scht.");
                } else {
                    p.sendMessage("\u00A7cWarp \u00A7b" + args[0] + " \u00A7cwurde nicht gel�scht, denn er wurde nicht gefunden.");
                }
            default:
                break;
        }
