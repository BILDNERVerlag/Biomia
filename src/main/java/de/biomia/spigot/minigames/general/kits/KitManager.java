...
public class KitManager {
    ...
    private static void initKits() {
        ...
        standartKit.setDescription(Arrays.asList("Die gute alte", "Standardausr00fcstung"));
        ...
        // Plattenspieler + Schallplatte mit ruhiger, ann00fcherend weihnachtlicher Musik
        ...
        ItemStack winter_chest = ItemCreator.itemCreate(Material.LEATHER_CHESTPLATE, "Eisr00fcstung");
