package de.biomia.minigames.sw.listeners;
...
import de.biomia.minigames.sw.gamestates.InGame;
import de.biomia.minigames.sw.ingame.Dead;
import de.biomia.minigames.sw.kits.Kit;
import de.biomia.minigames.sw.kits.Kits;
import de.biomia.minigames.sw.lobby.JoinTeam;
import de.biomia.minigames.sw.SkyWars;
import de.biomia.minigames.sw.messages.ItemNames;
                    ...
                    if (is.getItemMeta().getDisplayName().equals(ItemNames.teamJoinerSetter)) {
                        ...
                        if (is.getType().equals(Material.WOOL)) {
                            ...
                            if (team != null) {
                                ...
                                SkyWarsConfig.addTeamJoiner(uuid, team);
