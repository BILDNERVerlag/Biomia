package de.biomia.minigames.sw.kits;

import de.biomia.minigames.sw.messages.ItemNames;
import de.biomia.minigames.sw.var.Variables;
import de.biomia.api.Biomia;
import de.biomia.api.BiomiaPlayer;
import de.biomia.api.achievements.statEvents.skywars.KitChangeEvent;
...
public class Kits {
    ...
    public static void loadKits(Player p) {
        ...
        for (int i : SkyWarsKit.getAvailableKit(Biomia.getBiomiaPlayer(p)))
