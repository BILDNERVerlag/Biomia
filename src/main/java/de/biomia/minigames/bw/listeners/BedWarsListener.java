package de.biomia.minigames.bw.listeners;
...
import de.biomia.minigames.bw.gamestates.InGame;
import de.biomia.minigames.bw.ingame.Dead;
import de.biomia.minigames.bw.lobby.JoinTeam;
import de.biomia.minigames.bw.BedWars;
import de.biomia.minigames.bw.messages.ItemNames;
import de.biomia.minigames.bw.messages.Messages;
import de.biomia.minigames.bw.shop.Shop;
import de.biomia.minigames.bw.shop.ShopGroup;
import de.biomia.minigames.bw.shop.ShopItem;
import de.biomia.minigames.bw.var.*;
...
//					s.update();
//				}
//				BedWarsConfig.addSignsLocation(e.getBlock().getLocation(), i);
            }
        }
    }
