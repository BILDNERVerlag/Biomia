package de.biomia.server.minigames.versus.bw.shop;
...
class Shop {
    ...
    static {
        backItem = ItemCreator.headWithSkin("MHF_ArrowLeft", BedWarsItemNames.back);
    ...
    private static void init() {
        ...
        clay.setAmount(4);
        baumaterialien.addItem(new ShopItem(new Price(ItemType.BRONZE, 4), clay, true, ColorType.BLOCK));

        ItemStack glass = ItemCreator.itemCreate(Material.STAINED_GLASS);
        baumaterialien.addItem(new ShopItem(new Price(ItemType.BRONZE, 2), glass, true, ColorType.BLOCK));

        ItemStack glowstone = ItemCreator.itemCreate(Material.GLOWSTONE);
        baumaterialien.addItem(new ShopItem(new Price(ItemType.BRONZE, 2), glowstone));

        ItemStack ironblock = ItemCreator.itemCreate(Material.IRON_BLOCK);
        baumaterialien.addItem(new ShopItem(new Price(ItemType.IRON, 3), ironblock));
        ...
        baumaterialien.addItem(new ShopItem(new Price(ItemType.BRONZE, 5), woodpick));
        baumaterialien.addItem(new ShopItem(new Price(ItemType.IRON, 2), stonepick));
        baumaterialien.addItem(new ShopItem(new Price(ItemType.GOLD, 1), ironpick));

        // Waffen
        ItemStack stick = ItemCreator.itemCreate(Material.STICK);
        stick.addUnsafeEnchantment(Enchantment.KNOCKBACK, 1);
        waffen.addItem(new ShopItem(new Price(ItemType.BRONZE, 8), stick));
        ...
        waffen.addItem(new ShopItem(new Price(ItemType.IRON, 1), woodsword));
        ...
        waffen.addItem(new ShopItem(new Price(ItemType.IRON, 3), woodsword2));
        ...
        waffen.addItem(new ShopItem(new Price(ItemType.IRON, 5), stonesword));
        ...
        waffen.addItem(new ShopItem(new Price(ItemType.GOLD, 5), ironsword));

        ItemStack flintsteel = ItemCreator.itemCreate(Material.FLINT_AND_STEEL);
        waffen.addItem(new ShopItem(new Price(ItemType.IRON, 4), flintsteel));

        ItemStack rod = ItemCreator.itemCreate(Material.FISHING_ROD);
        rod.addUnsafeEnchantment(Enchantment.DURABILITY, 1);
        waffen.addItem(new ShopItem(new Price(ItemType.IRON, 5), rod));
        ...
        ruestung.addItem(new ShopItem(new Price(ItemType.BRONZE, 1), leathercap, true, ColorType.LEATHER));
        ruestung.addItem(new ShopItem(new Price(ItemType.BRONZE, 1), leatherpants, true, ColorType.LEATHER));
        ruestung.addItem(new ShopItem(new Price(ItemType.BRONZE, 1), leatherboots, true, ColorType.LEATHER));
        ruestung.addItem(new ShopItem(new Price(ItemType.BRONZE, 2), leatherchest, true, ColorType.LEATHER));
        ...
        ruestung.addItem(new ShopItem(new Price(ItemType.IRON, 2), chainchest1));
        ruestung.addItem(new ShopItem(new Price(ItemType.IRON, 5), chainchest2));
        ruestung.addItem(new ShopItem(new Price(ItemType.GOLD, 6), ironchest));
        ...
        boegen.addItem(new ShopItem(new Price(ItemType.GOLD, 3), bow1));
        boegen.addItem(new ShopItem(new Price(ItemType.GOLD, 6), bow2));
        boegen.addItem(new ShopItem(new Price(ItemType.GOLD, 12), bow3));
        boegen.addItem(new ShopItem(new Price(ItemType.GOLD, 1), arrow));

        // Essen
        ItemStack carrot = ItemCreator.itemCreate(Material.GOLDEN_CARROT);
        essen.addItem(new ShopItem(new Price(ItemType.BRONZE, 1), carrot));

        ItemStack steak = ItemCreator.itemCreate(Material.COOKED_BEEF);
        essen.addItem(new ShopItem(new Price(ItemType.BRONZE, 2), steak));

        ItemStack cake = ItemCreator.itemCreate(Material.CAKE);
        essen.addItem(new ShopItem(new Price(ItemType.IRON, 1), cake));

        ItemStack goldenApple = ItemCreator.itemCreate(Material.GOLDEN_APPLE);
        essen.addItem(new ShopItem(new Price(ItemType.GOLD, 1), goldenApple));

        // Tr\u00fcnke
        ItemStack heal1 = getPotionItemStack(Material.POTION, PotionType.INSTANT_HEAL, false);
        traenke.addItem(new ShopItem(new Price(ItemType.IRON, 1), heal1));

        ItemStack heal2 = getPotionItemStack(Material.POTION, PotionType.INSTANT_HEAL, true);
        traenke.addItem(new ShopItem(new Price(ItemType.IRON, 2), heal2));

        ItemStack heal3 = getPotionItemStack(Material.LINGERING_POTION, PotionType.INSTANT_HEAL, false);
        traenke.addItem(new ShopItem(new Price(ItemType.IRON, 2), heal3));

        ItemStack heal4 = getPotionItemStack(Material.LINGERING_POTION, PotionType.INSTANT_HEAL, true);
        traenke.addItem(new ShopItem(new Price(ItemType.IRON, 3), heal4));

        ItemStack speed = getPotionItemStack(Material.POTION, PotionType.SPEED, false);
        traenke.addItem(new ShopItem(new Price(ItemType.IRON, 6), speed));

        ItemStack regen = getPotionItemStack(Material.POTION, PotionType.REGEN, false);
        traenke.addItem(new ShopItem(new Price(ItemType.GOLD, 2), regen));

        ItemStack strength = getPotionItemStack(Material.POTION, PotionType.STRENGTH, false);
        traenke.addItem(new ShopItem(new Price(ItemType.GOLD, 7), strength));

        ItemStack wand = ItemCreator.itemCreate(Material.BRICK, BedWarsItemNames.wand);
        special.addItem(new ShopItem(new Price(ItemType.BRONZE, 64), wand));

        ItemStack warp = ItemCreator.itemCreate(Material.BLAZE_POWDER, BedWarsItemNames.warper);
        special.addItem(new ShopItem(new Price(ItemType.IRON, 3), warp));

        ItemStack platform = ItemCreator.itemCreate(Material.END_ROD, BedWarsItemNames.rettungsPlattform);
        special.addItem(new ShopItem(new Price(ItemType.GOLD, 3), platform));

        ItemStack shop = ItemCreator.itemCreate(Material.ARMOR_STAND, BedWarsItemNames.shortShop);
        special.addItem(new ShopItem(new Price(ItemType.GOLD, 5), shop));

        ItemStack enderpearl = ItemCreator.itemCreate(Material.ENDER_PEARL);
        special.addItem(new ShopItem(new Price(ItemType.GOLD, 11), enderpearl));

        ItemStack ladder = ItemCreator.itemCreate(Material.LADDER);
        special.addItem(new ShopItem(new Price(ItemType.BRONZE, 4), ladder));

        ItemStack cobweb = ItemCreator.itemCreate(Material.WEB);
        special.addItem(new ShopItem(new Price(ItemType.BRONZE, 16), cobweb));

        ItemStack tnt = ItemCreator.itemCreate(Material.TNT);
        special.addItem(new ShopItem(new Price(ItemType.GOLD, 3), tnt));

        ItemStack chest = ItemCreator.itemCreate(Material.CHEST);
        special.addItem(new ShopItem(new Price(ItemType.IRON, 1), chest));
    }
